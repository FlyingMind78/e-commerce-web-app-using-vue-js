<template>
  <form class="bg-glass shadow-3ht rounded px-8 pt-6 pb-8 mb-4">
    ...
    <div v-if="isFormLogin">
      ...
      <a class="inline-block mb-4 align-baseline font-bold text-sm text-white hover:text-gray-900" href="#"
        @click="switchForm">
        Create New Account
      </a>
    ...
    <!-- Sign up -->
    <div v-else>
      <h3 class="text-xl font-bold text-indigo-900 mb-4 m-0 text-center">
        Sign Up
      </h3>
      ...
      <div class="flex items-center justify-between">
        ...
        <a class="inline-block cursor-pointer align-baseline font-bold text-sm text-white hover:text-gray-900"
          @click="switchForm">
          Login
        </a>
        <a class="inline-block align-baseline font-bold text-sm text-white hover:text-gray-900" href="#">
    ...
    <error-modal-dialog @close-dialog="loginErrorHandler" v-if="isThereLoginError"></error-modal-dialog>
  </form>
</template>
...
import ErrorModalDialog from "../error/ErrorModalDialog.vue"
...
const { isThereLoginError } = storeToRefs(useAuthStore())
